...
Veja o [**GUIA\_CONFIGURACAO.md**](GUIA_CONFIGURACAO.md) para instruções
...
|`admin\_panel.py`|Aprovação de cadastros|
...
|`assets/`|Logos|
|`calibration.py`, `gamma\_engine.py`, ...|Motores de cálculo|
